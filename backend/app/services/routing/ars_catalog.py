...
ARS_TASK_KEYWORDS = {
    "S101": ["결제대금 확인", "연체대금 확인", "카드 결제대금", "이번 달 카드값", "카드값 얼마", "카드값이 얼마", "카드대금 확인"],
    "S102": ["카드 사용내역 조회", "카드사용내역 조회", "매출전표 조회", "카드 이용내역", "카드 쓴 내역", "카드 결제내역"],
    "S103": ["명세서 조회", "명세서 발송", "명세서 재발송", "카드 명세서 보내", "명세서 다시 보내"],
    "S104": ["신용카드 한도 조회", "체크카드 한도 조회", "카드 한도 확인", "카드 한도가 얼마"],
    "S105": ["신용카드 한도 상향", "체크카드 한도 상향", "카드 한도 올려", "한도 늘려", "한도를 늘리고"],
    "S106": ["결제대금 즉시결제", "카드값 즉시결제", "카드대금 미리 납부", "카드 선결제", "카드값 미리 낼게요"],
    "S108": ["입금내역 확인", "입금 내역 조회", "입금 확인해주세요"],
    ...
    "S112": ["카드 비밀번호 변경", "카드 비밀번호 등록", "카드 사용등록", "현금카드 겸용 등록", "카드 비밀번호를 바꾸고"],
    "S113": ["포인트 조회", "포인트를 조회", "통합 포인트 조회"],
    "S115": ["카드 재발급", "카드 갱신", "카드 새로 발급"],
    "S118": ["결제 예상금액", "결제예상금액 조회"],
    "S119": ["교통카드 이용내역", "하이패스 이용내역", "교통카드 내역", "하이패스 내역"],
    "S120": ["특별한도 조회", "특별한도 신청"],
    "S121": ["분할납부", "할부개월수 변경", "할부 개월 변경", "할부로 바꾸고"],
    ...
    "S127": ["리볼빙 신청", "일부결제금액이월약정 신청", "리볼빙으로 해주세요", "리볼빙 하고 싶어요"],
}
