    ...
    <>
      ...
      <div style={css("position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);z-index:81;width:680px;max-height:820px;background:var(--onair-surface);border-radius:12px;box-shadow:var(--sh-modal);overflow:hidden;display:flex;flex-direction:column;animation:modalIn .18s cubic-bezier(0.2,0.8,0.2,1)")}>
          ...
          <div style={css("display:flex;align-items:flex-start;gap:10px")}>
            <div style={css("flex:1;min-width:0")}>
              {sge === "E" ? (
                ...
                <span style={css("display:inline-flex;align-items:center;gap:6px;font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--green-900);background:var(--gray-100);border-radius:9999px;padding:4px 11px;margin-bottom:13px")}>
              ...
              <div style={css("display:flex;gap:13px")}>
                ...
                <div style={css("min-width:0")}>
                  <div style={css("display:flex;align-items:center;gap:6px;font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700);margin-bottom:7px")}>
                    ...
                    <span style={css("font:400 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>· 받기 전 미리 듣고 정리</span>
                    {meta && (
                      <span style={css("display:inline-flex;align-items:center;gap:5px;margin-left:6px;font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:" + meta.fg)}>
                        <span style={css("width:8px;height:8px;border-radius:9999px;flex:none;background:" + meta.bar)} />
                        {sge} · {meta.label}
                      </span>
                    )}
                  </div>
                  <div style={css("font:600 23px/1.35 'Avenir Next','Geist Sans','Pretendard',sans-serif;letter-spacing:-.3px;color:var(--gray-1000)")}>
                    {card ? card.summary : "분류 진행 중입니다…"}
                  </div>
                  {card && (
                    <div style={css("font:400 12.5px/1.55 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600);margin-top:7px")}>
            ...
            {record.confidence != null && (
              <span style={css("display:inline-flex;align-items:center;gap:8px;background:var(--onair-surface);border:1px solid var(--gray-300);border-radius:9999px;padding:4px 6px 4px 13px;flex:none;box-shadow:var(--sh-near)")}>
                <span style={css("display:flex;flex-direction:column;line-height:1.15")}>
                  <span style={css("font:600 9px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600);letter-spacing:.2px")}>AI 배정</span>
                  <span style={css("font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-800)")}>확신도</span>
                </span>
        ...
        <div style={css("flex:1;overflow:auto;padding:18px 24px;display:flex;flex-direction:column;gap:14px")}>
          ...
          <div style={css("display:flex;gap:12px;align-items:stretch")}>
            ...
            <div style={css("flex:1;min-height:104px;background:var(--gray-100);border-radius:8px;padding:12px 14px")}>
              <div style={css("display:flex;align-items:center;gap:6px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700);margin-bottom:8px")}>
                고객 감정온도
              ...
              <div style={css("display:flex;align-items:center;gap:12px")}>
                ...
                <div style={css("display:flex;align-items:baseline;gap:7px")}>
                  <span style={css("font:800 34px 'Avenir Next','Geist Sans','Pretendard',sans-serif;letter-spacing:-1.2px;color:" + (emotion ? EMOTION_INK[emotion] : "var(--gray-500)"))}>{emotion ? EMOTION_SCORE[emotion] : "--"}°</span>
                  <span style={css("font:800 15px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:" + (emotion ? EMOTION_INK[emotion] : "var(--gray-500)"))}>{emotion ? EMO_LABEL[emotion] : "—"}</span>
                </div>
              </div>
            </div>
            ...
            <div style={css("flex:1;min-height:104px;border-radius:8px;padding:12px 14px;background:" + (record.risk === "high" ? "var(--red-800)" : "var(--gray-100)"))}>
              <div style={css("font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;margin-bottom:7px;color:" + (record.risk === "high" ? "rgba(255,255,255,.85)" : "var(--gray-700)"))}>
              ...
              <div style={css("display:flex;align-items:center;gap:9px")}>
                ...
                <span style={css("font:800 26px 'Avenir Next','Geist Sans','Pretendard',sans-serif;letter-spacing:-.8px;color:" + (record.risk === "high" ? "#fff" : "var(--gray-1000)"))}>{record.risk === "high" ? "높음" : record.risk === "low" ? "낮음" : "—"}</span>
              </div>
              <div style={css("font:400 11.5px/1.45 'Avenir Next','Geist Sans','Pretendard',sans-serif;margin-top:6px;color:" + (record.risk === "high" ? "rgba(255,255,255,.88)" : "var(--gray-600)"))}>
          ...
          <div style={css("background:var(--gray-100);border-radius:8px;padding:13px 16px")}>
            <div style={css("display:flex;align-items:baseline;gap:7px;flex-wrap:wrap")}>
              <span style={css("font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700)")}>AI 배정</span>
              <span style={css("font:600 13px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000)")}>{record.department ?? card?.department ?? "분석 중"}</span>
              <span style={css("font:600 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700)")}>· {stateLabel}</span>
              {record.transferTo && (
                <span style={css("font:600 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-900)")}>· 이관 → {record.transferTo}</span>
              )}
            </div>
            {card?.routingReason && (
              <div style={css("font:400 12px/1.55 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-800);margin-top:6px")}>{card.routingReason}</div>
            )}
            ...
            {record.verified != null && (
              <div style={css("display:inline-flex;align-items:center;gap:6px;margin-top:10px;background:var(--onair-surface);border:1px solid " + (record.verified ? "var(--gray-300)" : "var(--amber-700)") + ";border-radius:9999px;padding:4px 11px 4px 8px")}>
                ...
                <span style={css("font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:" + (record.verified ? "var(--gray-900)" : "var(--amber-900)"))}>
                  본인인증 {record.verified ? "완료" : "미완료"}
                </span>
                <span style={css("font:400 10px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>
          ...
          {/* 이 콜의 파이프라인 진행 */}
          <div>
            <div style={css("font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700);margin-bottom:2px")}>백엔드 처리 진행</div>
        ...
        <div style={css("flex:none;display:flex;align-items:center;gap:12px;padding:13px 24px;box-shadow:var(--sh-joint);background:var(--gray-100)")}>
          ...
          <span style={css("font:600 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:" + (card?.source === "backend" ? "var(--green-900)" : "var(--gray-700)"))}>
