    ...
    <DesktopShell flex>
      ...
      <div style={css("height:74px;flex:none;position:relative;z-index:5")}>
        ...
        <div className="pill" style={css("position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);animation:fadeIn .7s ease-out .35s both")}>
          {vm.showWrap ? (
            ...
            <span style={css("display:flex;align-items:center;gap:7px;font:600 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-800)")} title="통화 종료 — 온에어 소등">
              <span className="onairdot off" />
              <span className="mi" style={css("font-size:14px;color:var(--green-700)")}>check_circle</span> 녹취 완료
            </span>
          ) : (
            <span style={css("display:flex;align-items:center;gap:7px;font:600 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--red-900)")} title="온에어 — 통화·녹취 중">
              <span className="onairdot" /> 녹취 중
            </span>
          )}
          {vm.isUrgent && (
            <span style={css("font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:#fff;background:var(--red-800);border-radius:9999px;padding:3px 9px")}>긴급</span>
          )}
          ...
          <span style={css("display:flex;align-items:center;gap:6px")}>
            ...
            <span style={css("font:500 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700)")}>AI 배정</span>
            <span style={css("font:600 14px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000)")}>{vm.prepRoutingTitle}</span>
          </span>
          <span style={css("width:1.3px;height:22px;background:var(--gray-200)")} />
          <span style={css("display:flex;align-items:center;gap:7px")} title="고객 감정온도">
            <span style={css("font:500 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700)")}>감정온도</span>
            ...
            <span style={css("font:600 14px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:" + vm.prepEmotionFg)}>{vm.prepEmotionLabel}</span>
          </span>
          <span style={css("width:1.3px;height:22px;background:var(--gray-200)")} />
          <span style={css("display:flex;align-items:center;gap:5px")}>
            ...
            <span style={css("font:500 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700)")}>사고 징후</span>
            <span style={css("font:600 14px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:" + vm.prepRiskFg)}>{vm.prepRiskLabel}</span>
          </span>
          ...
          {vm.transferReserved && (
            <span style={css("display:flex;align-items:center;gap:5px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-900);background:var(--gray-100);border-radius:9999px;padding:3px 5px 3px 9px;white-space:nowrap")}>
          ...
          {held && (
            <span style={css("display:flex;align-items:center;gap:4px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--amber-900);background:var(--gray-100);border-radius:9999px;padding:3px 9px;white-space:nowrap")}>
                  ...
                  <div style={css("position:absolute;left:0;top:calc(100% + 6px);z-index:41;width:252px;background:var(--onair-surface);border-radius:10px;box-shadow:var(--sh-modal);overflow:hidden")}>
                    ...
                    {vm.transferReserved && (
                      <div onClick={() => { vm.toggleTransferReserve(); setTransferMenu(false); }} className="memorow" style={css("display:flex;align-items:center;gap:6px;padding:9px 13px;cursor:pointer;border-bottom:1px solid var(--gray-100);color:var(--red-800)")}>
                        ...
                        <span style={css("font:600 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif")}>이관 예약 취소 · {vm.transferTarget ?? vm.suggestedDept}</span>
                      </div>
                    )}
          ...
          <span data-tour="call-end" style={css("position:relative")}>
            ...
            {endConfirm && (
              <div style={css("position:absolute;top:48px;right:0;width:220px;background:var(--onair-surface);border-radius:12px;box-shadow:var(--sh-modal);padding:13px 14px;z-index:40;animation:dockDown .15s cubic-bezier(0.2,0.8,0.2,1)")}>
                <div style={css("font:700 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);margin-bottom:9px")}>통화를 종료할까요?</div>
                <div style={css("display:flex;gap:6px")}>
                  <span onClick={vm.endCall} style={css("flex:1;text-align:center;padding:7px 0;border-radius:9999px;background:var(--red-800);color:#fff;font:700 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;cursor:pointer")}>종료</span>
                  <span onClick={() => setEndConfirm(false)} style={css("flex:1;text-align:center;padding:7px 0;border-radius:9999px;background:var(--gray-100);color:var(--gray-900);font:600 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;cursor:pointer")}>계속 통화</span>
                </div>
              </div>
            )}
          </span>
        ...
        <div ref={leftColRef} data-tour="call-left" style={css("width:320px;flex:none;display:flex;flex-direction:column;gap:14px;min-height:0;overflow-y:auto;overflow-x:hidden;animation:consoleInL .85s cubic-bezier(.2,.8,.2,1) .2s both")}>
          <div className="card" style={css("padding:13px 15px;display:flex;align-items:center;gap:12px" + (vm.verified ? ";opacity:.93" : ""))}>
            ...
            <div style={css("flex:1;min-width:0")}>
              <div style={css("display:flex;align-items:center;gap:6px")}>
                ...
                <span style={css("font:400 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>통화 중</span>
              </div>
              <div style={css("font:400 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700);margin-top:1px")}>{AGENT.dept} · {AGENT.tenure} · {AGENT.id}</div>
            </div>
          ...
          <div className="card" style={css("padding:16px" + (vm.verified ? "" : ";min-height:418px") + (focus === "customer" ? ";box-shadow:var(--sh-focus)" : ""))}>
            <div style={css("display:flex;align-items:center;justify-content:space-between;margin-bottom:12px")}>
              ...
              <span style={css("display:inline-flex;align-items:center;gap:4px;font:500 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600);background:var(--gray-100);border:1px solid var(--gray-200);border-radius:9999px;padding:3px 10px")}>
            ...
            <div style={css("display:flex;align-items:center;gap:12px")}>
              ...
              <div>
                ...
                <div style={css("font:400 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700);margin-top:2px")}>
            ...
            {vm.arsDigits && (
              <div style={css("margin-top:12px;display:flex;align-items:center;gap:9px;padding:9px 11px;border:1px solid var(--blue-400);background:var(--blue-50,#eef4ff);border-radius:8px")}>
                ...
                <div style={css("flex:1;min-width:0")}>
                  <div style={css("display:flex;align-items:center;gap:6px") }>
                    <span style={css("font:700 11.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-900)")}>고객 키패드 입력 수신</span>
                    <span style={css("font:500 10px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:" + (vm.dtmfPersisted ? "var(--green-700)" : "var(--red-800)"))}>
                ...
                {!vm.verified && (
                  <span
                    ...
                    style={css("flex:none;border-radius:9999px;padding:6px 9px;background:var(--onair-surface);border:1px solid var(--blue-400);font:700 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-700);cursor:" + (vm.canApplyDtmfToAuth ? "pointer" : "not-allowed"))}
                  >
                    대조값에 적용
                  </span>
                )}
            ...
            {vm.verified ? (
              <div style={css("margin-top:13px;background:var(--gray-100);border-radius:8px;overflow:hidden")}>
                <div style={css("display:flex;align-items:center;gap:9px;padding:10px 12px;border-bottom:1px solid var(--gray-300)")}>
                  ...
                  <div style={css("flex:1")}>
                    <span style={css("font:700 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--green-900)")}>본인인증 완료</span>
                    <span style={css("font:400 11px 'Geist Mono','IBM Plex Mono',monospace;color:var(--green-600);margin-left:6px")}>{vm.authTime}</span>
                  </div>
                  <span onClick={vm.resetAuth} style={css("display:flex;align-items:center;gap:2px;font:400 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600);cursor:pointer")}>
                    재인증 <span className="mi" style={css("font-size:15px")}>restart_alt</span>
                  </span>
                </div>
                <div style={css("padding:10px 12px;font:400 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-900)")}>
              ...
              <div style={css("margin-top:13px;background:var(--gray-100);border:1px solid var(--gray-300);border-radius:8px;padding:12px")}>
                ...
                <div style={css("display:flex;align-items:center;gap:6px;font:700 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);margin-bottom:3px")}>
                  <span style={css("width:7px;height:7px;border-radius:9999px;background:var(--gray-500)")} />
                  본인확인 · 미완료
                </div>
                <div style={css("font:400 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700);margin-bottom:11px")}>
                ...
                <div style={css("display:flex;flex-direction:column;gap:10px;align-items:stretch")}>
                  ...
                  <span onClick={vm.runVerify} style={css("display:flex;align-items:center;justify-content:center;padding:9px 16px;background:var(--blue-700);color:#fff;border-radius:9999px;font:700 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;cursor:pointer")}>대조</span>
                </div>
                {vm.authErr && (
                  <div style={css("margin-top:7px;display:flex;align-items:center;gap:4px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--red-800)")}>
                    <span className="mi" style={css("font-size:13px")}>error</span>
                    {vm.authErrMsg}
                  </div>
                )}
                <div style={css("display:flex;align-items:center;gap:5px;margin-top:9px;font:400 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>
            ...
            <div style={css("margin-top:12px")}>
              <div style={css("font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700);margin-bottom:7px")}>
                  ...
                  <div key={i} style={css("display:flex;gap:11px")}>
                    ...
                    <div style={css("flex:1;padding:8px 0 14px")}>
                      <div style={css("display:flex;align-items:center;gap:6px")}>
                        ...
                        <span style={css("font:400 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>· {h.ago}</span>
                        {i === 0 && (
                          <span style={css("font:600 10px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-900)")}>가장 최근</span>
                        )}
                        <span style={css("font:400 10px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--green-900);margin-left:auto;background:var(--gray-100);border-radius:9999px;padding:2px 8px")}>완결</span>
                      </div>
                      <div style={css("font:600 13px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);margin-top:3px")}>{h.label}</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {vm.verified && showAccounts && (
            <div className="card" style={css("flex:none;display:flex;flex-direction:column;overflow:hidden;animation:dockDown .25s cubic-bezier(0.2,0.8,0.2,1)")}>
                ...
                {ACCOUNTS.map((a, i) => (
                  <div key={i} style={css("padding:10px 14px" + (i < ACCOUNTS.length - 1 ? ";border-bottom:1px solid var(--gray-200)" : ""))}>
                    <div style={css("display:flex;align-items:center;gap:7px")}>
                      <span style={css("font:600 10px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-800);background:var(--gray-100);border-radius:9999px;padding:2px 8px;flex:none")}>{a.kind}</span>
                      <span style={css("font:600 13px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000)")}>{a.name}</span>
                      <span style={css("font:400 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--green-900);margin-left:auto")}>정상</span>
                    </div>
              ...
              <div style={css("padding:8px 15px;border-top:1px solid var(--gray-200);font:400 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>
                읽기 전용 · 고객 동의 하 열람
              </div>
            </div>
          )}
        ...
        <div data-tour="call-center" style={css("flex:1;min-width:0;display:flex;flex-direction:column;gap:14px;animation:consoleSettle .9s cubic-bezier(.2,.8,.2,1)")}>
          <div className="card" style={css("flex:none;padding:15px 17px")}>
            <div style={css("display:flex;align-items:center;gap:6px;margin-bottom:9px")}>
              ...
              <span style={css("font:800 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;letter-spacing:.2px;color:var(--gray-1000)")}>KARI-NA 브리핑</span>
              <span style={css("font:400 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>· {vm.summarySourceLabel}</span>
            </div>
            ...
            <div style={css("display:flex;flex-wrap:wrap;align-items:center;gap:6px;margin-bottom:11px")}>
              <span style={css("display:inline-flex;align-items:center;gap:4px;font:700 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-700);background:var(--gray-100);border-radius:9999px;padding:3px 9px")}>
                <span className="mi" style={css("font-size:13px")}>alt_route</span>자동 라우팅
              </span>
              {(() => { const m = SGE_META[vm.prepSge]; return (
                <span title={m.desc} style={css("display:inline-flex;align-items:center;gap:5px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;background:var(--gray-100);border-radius:9999px;padding:3px 10px;color:" + m.fg)}>
                  <span style={css("width:6px;height:6px;border-radius:9999px;background:" + m.bar)} />SGE {vm.prepSge}·{m.label}
                </span>
              ); })()}
              <span style={css("display:inline-flex;align-items:center;gap:4px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;background:var(--gray-100);border-radius:9999px;padding:3px 10px;color:var(--gray-1000)")}>
              ...
              {vm.prepConfidencePct != null && (
                <span style={css("display:inline-flex;align-items:baseline;gap:4px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;background:var(--gray-100);border-radius:9999px;padding:3px 10px;color:var(--gray-1000)")}>
                  <span style={css("font-weight:500;color:var(--gray-600)")}>확신</span>{vm.prepConfidencePct}%
                </span>
              )}
            </div>
            {/* 라우팅 근거 — 왜 이 부서로 왔는지 한 줄 */}
            <div style={css("display:flex;gap:6px;align-items:baseline;margin-bottom:11px;font:400 11.5px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>
            ...
            <div style={css("font:600 18px/1.4 'Avenir Next','Geist Sans','Pretendard',sans-serif;letter-spacing:-.2px;color:var(--gray-1000);margin-bottom:11px")}>{vm.prepHeadline}</div>
            {/* 전화 요약 — 고객 발화 STT를 요약한 내용(대화 요약) */}
            <div style={css("display:flex;align-items:center;gap:5px;font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600);margin-bottom:9px")}>
            ...
            <div style={css("display:flex;flex-direction:column;gap:8px")}>
              {vm.summaryPoints.map((t, i) => (
                <div key={i} style={css("display:flex;gap:10px;align-items:baseline")}>
                  ...
                  <span style={css("font:400 14px/1.55 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-900)")}>{t}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="card" style={css("flex:none;min-height:0;display:flex;flex-direction:column;overflow:hidden")}>
            ...
            >
              <span className="sechd" style={css("display:flex;align-items:center;gap:6px")}>
                ...
                <span style={css("font:400 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-500)")}>· {vm.steps.length}단계</span>
              </span>
              <span style={css("display:flex;align-items:center;gap:4px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>
                {scriptOpen ? "접기" : "펼쳐 보기"}
              ...
              <div style={css("overflow:auto;max-height:320px;padding:14px 16px;display:flex;flex-direction:column;gap:9px")}>
                {vm.steps.map((st, i) => (
                  <div key={i} style={css("background:var(--gray-100);border-radius:8px;padding:11px 13px")}>
                    <div style={css("font:600 14px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);margin-bottom:5px")}>{st.title}</div>
                    <div style={css("font:400 14px/1.6 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-900)")}>{st.text}</div>
                  </div>
                ))}
              </div>
            )}
          ...
          <div className="card" style={css("flex:1;min-height:196px;display:flex;flex-direction:column" + (focus === "memo" ? ";box-shadow:var(--sh-focus)" : vm.verified ? "" : ";opacity:.93"))}>
            <div style={css("display:flex;align-items:center;justify-content:space-between;padding:11px 16px;border-bottom:1px dashed var(--color-border)")}>
              ...
              <span style={css("font:400 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>불릿 자동 · 종료 시 후처리에 반영</span>
            </div>
            ...
            >
                ...
                <div key={i} className="memorow" style={css("display:flex;gap:8px;align-items:baseline")}>
                  ...
                  {editIdx === i ? (
                    <input
                      ...
                      style={css("flex:1;min-width:0;border:none;outline:none;border-bottom:1px solid var(--blue-400);font:400 14px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);background:transparent;padding:0")}
                    />
                  ) : (
                    <>
                      <span style={css("flex:1;min-width:0;font:400 14px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000)")}>{m}</span>
              ...
              {vm.memoEmpty && (
                <div style={css("font:400 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-500)")}>특이사항을 입력하면 불릿으로 기록됩니다</div>
              )}
            </div>
            <div style={css("flex:none;display:flex;align-items:center;gap:8px;padding:9px 14px;border-top:1px solid var(--gray-200)")}>
              ...
              <input
                ...
                style={css("flex:1;border:none;outline:none;font:400 14px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);background:transparent")}
              />
            </div>
          </div>
        </div>
        ...
        <div data-tour="call-right" style={css("width:" + (regWide ? 640 : 372) + "px;flex:none;display:flex;flex-direction:column;gap:14px;min-height:0;transition:width .35s cubic-bezier(0.2,0.8,0.2,1);animation:consoleInR .85s cubic-bezier(.2,.8,.2,1) .2s both")}>
          <div className="card" style={css("flex:" + (regWide ? "1" : "none") + ";min-height:0;display:flex;flex-direction:column;overflow:hidden" + (focus === "reg" ? ";box-shadow:var(--sh-focus)" : ";opacity:" + (vm.verified ? ".95" : ".9")))}>
            ...
            <div style={css("display:flex;align-items:center;gap:8px;padding:12px 14px;border-bottom:1px dashed var(--color-border)")}>
              ...
              {regWide && (
                <span onClick={vm.closeReg} title="규정집 축소 · 단축키 R" style={css("flex:none;display:inline-flex;align-items:center;gap:3px;font:600 11.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-700);border:1px solid var(--blue-400);border-radius:9999px;padding:5px 10px;cursor:pointer")}>
            ...
            {regWide && (
              <div style={css("display:flex;align-items:center;gap:6px;flex-wrap:wrap;padding:8px 14px;border-bottom:1px solid var(--gray-200);background:var(--gray-100)")}>
                ...
                <select
                  ...
                  style={css("font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);background:var(--onair-surface);border:1px solid " + (vm.regDocType ? "var(--blue-400)" : "var(--gray-300)") + ";border-radius:9999px;padding:4px 8px;cursor:pointer;outline:none")}
                >
                ...
                <select
                  ...
                  style={css("font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);background:var(--onair-surface);border:1px solid " + (vm.regDeptFilter ? "var(--blue-400)" : "var(--gray-300)") + ";border-radius:9999px;padding:4px 8px;cursor:pointer;outline:none")}
                >
                ...
                <select
                  ...
                  style={css("font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);background:var(--onair-surface);border:1px solid " + (vm.regEffFrom ? "var(--blue-400)" : "var(--gray-300)") + ";border-radius:9999px;padding:4px 8px;cursor:pointer;outline:none")}
                >
                ...
                <span
                  ...
                  title="표(테이블) 청크만 보기"
                  style={css("display:inline-flex;align-items:center;gap:3px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;border-radius:9999px;padding:4px 10px;cursor:pointer;" + (vm.regTableOnly ? "background:var(--blue-700);color:#fff" : "background:var(--onair-surface);color:var(--gray-800);border:1px solid var(--gray-300)"))}
                >
                  <span className="mi" style={css("font-size:14px")}>table_rows</span>표만
                </span>
                {vm.regFilterCount > 0 && (
                  <span onClick={vm.clearRegFilters} style={css("display:inline-flex;align-items:center;gap:2px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600);cursor:pointer;margin-left:auto")}>
            ...
            {!regWide ? (
              ...
              <div style={css("flex:1;min-height:0;overflow:auto;width:372px;animation:fadeIn .25s ease-out")}>
                <div style={css("padding:11px 15px 0;display:flex;align-items:center;gap:5px;font:400 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>
                ...
                <div style={css("padding:13px 15px;display:flex;flex-direction:column;gap:14px")}>
                  <div>
                    <div style={css("display:flex;align-items:center;gap:5px;font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-700);margin-bottom:8px")}>
                    ...
                    <div style={css("display:flex;flex-direction:column;gap:9px")}>
                      {vm.knowledgeReferences.length ? (
                        ...
                        <div style={css("font:400 12px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700)")}>
                  ...
                  {!vm.isExplicitLiveCall && <div>
                    <div style={css("font:700 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700);margin-bottom:8px")}>규정집 파일 바로가기</div>
                    <div style={css("display:flex;flex-direction:column;gap:7px")}>
              ...
              <div style={css("width:640px;flex:1;min-height:0;display:flex;flex-direction:column;animation:fadeIn .25s ease-out")}>
                ...
                <div style={css("display:flex;align-items:center;gap:8px;padding:9px 14px;background:var(--gray-100);color:var(--gray-1000);border-bottom:1px solid var(--gray-300)")}>
                  ...
                  <span style={css("font:600 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif")}>{vm.regFile}</span>
                  ...
                  <span style={css("margin-left:auto;display:flex;align-items:center;gap:6px")}>
                    <label title="실제 규정 파일 열기 (CSV·XLSX)" style={css("display:flex;align-items:center;gap:4px;cursor:pointer;background:var(--onair-surface);border:1px solid var(--gray-300);border-radius:9999px;padding:4px 10px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif")}>
                  ...
                  <div style={css("display:flex;flex-direction:column")}>
                    <div style={css("display:flex;position:sticky;top:0;z-index:1")}>
                      ...
                      {vm.regCols.slice(0, 3).map((c, i) => (
                        <span key={i} style={css((i === 2 ? "flex:1;min-width:0" : "width:" + c.w + "px;flex:none") + ";padding:8px 10px;background:var(--gray-100);border-right:1px solid var(--gray-300);border-bottom:1px solid var(--gray-300);font:700 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-900)")}>{c.l}{i === 2 ? " · 안내 멘트" : ""}</span>
                      ))}
                    </div>
                    {vm.regRows.map((r) => {
                      ...
                      return (
                        <div key={r.n} style={css("display:flex" + (hit ? ";box-shadow:inset 0 0 0 1.5px var(--gray-1000);position:relative;z-index:1" : ""))}>
                          ...
                          {r.cells.slice(0, 2).map((cell, ci) => (
                            <span key={ci} style={css("width:" + cell.w + "px;flex:none;padding:8px 10px;border-right:1px solid var(--gray-200);border-bottom:1px solid var(--gray-200);font:" + (hit ? "600" : "400") + " 12px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);background:" + (hit ? "var(--gray-100)" : "transparent"))}>{highlight(cell.text, vm.regSearch)}</span>
                          ))}
                          <span style={css("flex:1;min-width:0;padding:8px 10px;border-bottom:1px solid var(--gray-200);background:" + (hit ? "var(--gray-100)" : "transparent"))}>
                            <span style={css("display:block;font:" + (hit ? "600" : "400") + " 12px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000)")}>{highlight(r.cells[2].text, vm.regSearch)}</span>
                            {ment && (
                    ...
                    {vm.regRows.length === 0 && (
                      <div style={css("padding:26px 0;text-align:center;font:400 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>
                ...
                <div style={css("display:flex;align-items:center;gap:2px;padding:6px 10px;background:var(--gray-100);border-top:1px solid var(--gray-300)")}>
                  <span style={css("font:600 11.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;background:#fff;border:1px solid var(--gray-300);border-bottom:none;border-radius:4px 4px 0 0;padding:5px 12px;color:var(--gray-1000)")}>{vm.regSheet}</span>
                  <span style={css("font:400 11.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;padding:5px 12px;color:var(--gray-600)")}>Sheet2</span>
                </div>
              </div>
            )}
          </div>
      ...
      {!vm.showWrap && (
        <div style={css("position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:1240px;height:34px;background:var(--onair-surface);border-radius:12px 12px 0 0;box-shadow:var(--sh-modal);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;animation:fadeIn .7s ease-out .45s both")}>
          ...
          <span style={css("font:500 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>통화를 종료하면 여기서 후처리가 이어집니다</span>
        </div>
      )}
    </DesktopShell>
  );
...
function RegDocSheet({ vm }: { vm: CallFlowVM }) {
  ...
  return (
    <div style={css("width:640px;flex:1;min-height:0;display:flex;flex-direction:column;animation:fadeIn .25s ease-out")}>
      <div style={css("display:flex;align-items:center;gap:8px;padding:9px 14px;background:var(--gray-100);color:var(--gray-1000);border-bottom:1px solid var(--gray-300)")}>
        <span onClick={vm.closeRegDoc} title="검색 결과로 돌아가기" style={css("display:flex;align-items:center;gap:3px;cursor:pointer;background:var(--onair-surface);border:1px solid var(--gray-300);border-radius:9999px;padding:4px 10px;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif")}>
          <span className="mi" style={css("font-size:14px")}>arrow_back</span>검색
        </span>
        <span className="mi" style={css("font-size:18px")}>grid_on</span>
        <span style={css("font:600 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;overflow:hidden;text-overflow:ellipsis;white-space:nowrap")}>{doc ? doc.title : "원문 불러오는 중…"}</span>
        {doc && (
        ...
        <span style={css("margin-left:auto;flex:none;font:400 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:170px")}>{doc?.source_file ?? ""}</span>
      </div>
      <div style={css("flex:1;min-height:0;overflow-y:auto;background:#fff")}>
        {!doc ? (
          ...
          <div style={css("display:flex;flex-direction:column")}>
            ...
            <div style={css("display:flex;position:sticky;top:0;z-index:2")}>
              {[["#", 40], ["섹션", 160], ["내용", 0]].map(([l, w], i) => (
                <span key={i} style={{ ...css((w ? "width:" + w + "px;flex:none" : "flex:1;min-width:0") + ";padding:8px 10px;border-right:1px solid " + XL_GRID + ";font:700 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif"), background: XL_HEAD, color: XL_HEAD_FG }}>{l}</span>
              ))}
            </div>
            {/* 앞 생략분 — 눌러서 전체 펼치기 */}
            {windowed && from > 0 && (
              <div onClick={() => setShowAll(true)} className="memorow" style={css("display:flex;align-items:center;justify-content:center;gap:5px;padding:7px 0;background:" + XL_GUT + ";border-bottom:1px solid " + XL_GRID + ";cursor:pointer;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-700)")}>
            ...
            {chunks.slice(from, to).map((c, li) => {
              ...
              return (
                <div key={c.chunk_id} ref={hit ? hitRef : undefined} style={css("display:flex" + (hit ? ";box-shadow:inset 0 0 0 1.5px var(--blue-700);position:relative;z-index:1" : ""))}>
                  ...
                  <span style={{ ...css("width:160px;flex:none;padding:9px 10px;border-right:1px solid " + XL_GRID + ";border-bottom:1px solid " + XL_GRID + ";font:" + (hit ? "700" : "600") + " 11.5px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-800);overflow:hidden;text-overflow:ellipsis"), background: bg }}>{c.section ?? ""}</span>
                  <div style={{ ...css("flex:1;min-width:0;padding:9px 12px;border-bottom:1px solid " + XL_GRID), background: bg }}>
                    {c.kind === "table" ? (
                      ...
                      <span style={css("font:" + (hit ? "600" : "400") + " 12.5px/1.7 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);white-space:pre-wrap")}>{highlight(cleanChunk(c.text), vm.regSearch)}</span>
                    )}
                  </div>
                </div>
              );
            ...
            {windowed && to < chunks.length && (
              <div onClick={() => setShowAll(true)} className="memorow" style={css("display:flex;align-items:center;justify-content:center;gap:5px;padding:7px 0;background:" + XL_GUT + ";cursor:pointer;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-700)")}>
      ...
      <div style={{ ...css("display:flex;align-items:center;gap:6px;padding:6px 12px;background:" + XL_BAND + ";border-top:1px solid " + XL_GRID + ";font:400 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)") }}>
        ...
        {hitIdx >= 0 && chunks.length > 2 * WIN + 1 && (
          <span onClick={() => setShowAll((v) => !v)} style={css("display:inline-flex;align-items:center;gap:3px;font:600 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-700);cursor:pointer")}>
  ...
  return (
    <div style={css("width:640px;flex:1;min-height:0;display:flex;flex-direction:column;animation:fadeIn .25s ease-out")}>
      ...
      <div style={css("display:flex;align-items:center;gap:8px;padding:9px 14px;background:var(--gray-100);color:var(--gray-1000);border-bottom:1px solid var(--gray-300)")}>
        ...
        <span style={css("font:600 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif")}>“{vm.regSearch}” 검색 결과</span>
      ...
      <div style={css("flex:1;min-height:0;overflow-y:auto;background:#fff")}>
        {vm.semLoading && vm.semHits.length === 0 ? (
          ...
          <div style={css("padding:36px 0;text-align:center;font:400 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600)")}>“{vm.regSearch}” 검색 결과 없음</div>
        ) : (
        <div style={css("display:flex;flex-direction:column")}>
          ...
          {vm.semHits.map((h, ri) => {
            ...
            <div key={h.chunk_id} onClick={() => vm.openRegDocReal(h.doc_id, h.chunk_id)} style={css("display:flex;cursor:pointer")}>
              ...
              <span style={{ ...css("width:180px;flex:none;padding:9px 10px;border-right:1px solid " + XL_GRID + ";border-bottom:1px solid " + XL_GRID + ";font:600 11.5px/1.45 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);overflow:hidden;text-overflow:ellipsis"), background: bg }}>{h.title}</span>
              <span style={{ ...css("flex:1;min-width:0;padding:9px 12px;border-bottom:1px solid " + XL_GRID + ";font:400 12.5px/1.65 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000)"), background: bg }}>{highlight(stripPipes(h.excerpt), vm.regSearch)}</span>
            </div>
            );
          })}
        </div>
      ...
      <div style={css("display:flex;align-items:center;gap:3px;padding:5px 10px;background:var(--gray-100);border-top:1px solid " + XL_GRID + ";overflow-x:auto")}>
        ...
        <span style={css("flex:none;font:400 10.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-600);margin-right:5px")}>매칭 {files.length}개</span>
        {files.map((f) => (
          <span
            key={f.doc_id}
            onClick={() => vm.openRegDocReal(f.doc_id, f.chunk_id)}
            title={f.title + " 원문 열기"}
            style={css("flex:none;max-width:190px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font:600 11px 'Avenir Next','Geist Sans','Pretendard',sans-serif;background:#fff;border:1px solid " + XL_GRID + ";border-bottom:none;border-radius:5px 5px 0 0;padding:5px 12px;color:var(--gray-1000);cursor:pointer")}
          >
            {f.title}
          </span>
        ))}
...
function MiniTable({ raw, q }: { raw: string; q: string }) {
  ...
  if (!rows.length) return <span style={css("font:400 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-700)")}>{stripPipes(raw)}</span>;
  return (
              ...
              {cells.map((cell, ci) => (
                <td
                  ...
                  style={{
                    ...
                    font: (ri === 0 ? "700" : "400") + " 11.5px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif",
...
function RegReco({ vm, title, body, file, row }: { vm: CallFlowVM; title: string; body: string; file: string; row: number }) {
  return (
    <div style={css("background:var(--gray-100);border-radius:8px;padding:11px 13px")}>
      <div style={css("font:700 12.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);margin-bottom:5px")}>{title}</div>
      <div style={css("font:400 12px/1.5 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-900)")}>{body}</div>
      <div style={css("display:flex;align-items:center;justify-content:space-between;margin-top:8px")}>
        ...
        <span onClick={() => vm.openManualAt(row)} style={css("display:inline-flex;align-items:center;gap:4px;font:600 11.5px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--blue-700);border:1px solid var(--blue-400);background:var(--onair-surface);border-radius:9999px;padding:4px 11px;cursor:pointer")}>
...
function RegFile({ vm, name }: { vm: CallFlowVM; name: string }) {
  return (
    <span onClick={vm.openManual} style={css("display:flex;align-items:center;gap:8px;background:var(--gray-100);border-radius:9999px;padding:9px 14px;font:600 12px 'Avenir Next','Geist Sans','Pretendard',sans-serif;color:var(--gray-1000);cursor:pointer")}>
