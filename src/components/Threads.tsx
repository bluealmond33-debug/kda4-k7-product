// React Bits <Threads /> — WebGL 유동 라인 (JavaScript + CSS variant를 TS로 이식).
// 고객 화면 실시간 통화 패널 상단에서 "음성이 흐르고 있다"를 표현한다 —
// amplitude prop이 라이브 유니폼으로 반영되므로 발화/음량에 따라 실시간으로 출렁인다.
// deps: ogl
